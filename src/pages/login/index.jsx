  ...
  return (
    <div className="login-wrapper">
      ...
      <div className="login-tabs">
        <span className={tabType === 'login' ? 'active' : ''} onClick={() => setTabType('login')}>
          登录
        </span>
        <span className={tabType === 'register' ? 'active' : ''} onClick={() => setTabType('register')}>
          注册
        </span>
      </div>
      ...
      <div className="login-btn">
        {tabType === 'login' ? (
          <Button block theme="primary" onClick={login}>
            登录
          </Button>
        ) : (
